...
**Priority Stack — Self-hosted sovereign infrastructure: Headscale VPN, Keycloak IAM, EspoCRM, vLLM serving. Docker Compose + deploy scripts for Raspberry Pi fleet.**
